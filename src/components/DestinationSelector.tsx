       ...
       <>
        ...
        <div className='flex justify-between px-8'>
            {destinationList.map(dest => (
                <button onClick={() => setSelectedDestinations(dest)} key={dest} className={clsx('font-sans-codensed text-sm tracking-wider uppercase transition-colors duration-300 relative', selectedDestinations === dest ? 'text-white' : 'text-blue-300')}>
                    <span>{dest}</span>
        ...
        <div className='flex flex-col gap-4 mt-4'>
            <h2 className='uppercase text-white font-serif text-center text-6xl'>{selectedDestinations}</h2>
